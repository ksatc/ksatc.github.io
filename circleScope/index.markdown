...
description: CircleScope は、コミックマーケット Webカタログのサークルチェックを Mac で快適に行うためのカタログ閲覧支援アプリです。C108向け・BOOTHで配布中。
---

# CircleScope for C108
コミケ Webカタログを、**Macの大きな画面でサクサク整理したい人向け**のカタログアプリです。
対応イベントは**コミックマーケット 108（C108）専用**。価格は**500円（税込）**、BOOTH にて配布中です。

<div class="buttons">
  <a class="btn primary" href="https://linelab.booth.pm/items/8572972">BOOTHで購入する</a>
...
CircleScopeは、**WebカタログGold(有料会員)向け**のカタログアプリです。
...
<div class="screenshots">
  <figure>
    ...
    <figcaption>サークル一覧＋詳細を1画面で。配置図から気になるサークルをすぐチェック</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>カード形式でペラペラめくって確認できるデッキビュー</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>お気に入りは色分けで管理。チェック状況がすぐ分かる</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>会場マップとジャンルの色分けで配置を確認</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>キーワード検索で目的のサークルへ。通販リンクもまとめて表示</figcaption>
  </figure>
</div>
...
- コミックマーケット108（C108）専用
- C107版はこちら：[CircleScope for C107](/circleScope/c107/)（**無料でお試しいただけます**）
...
- 価格：**500円（税込）**
- 配布：[BOOTHで購入する](https://linelab.booth.pm/items/8572972)

無料の [CircleScope for C107](/circleScope/c107/) で先に操作感を試すこともできます。
...
操作方法で困ったときは [よくある質問（FAQ）](/circleScope/faq/) もご覧ください。
